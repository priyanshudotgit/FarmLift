...
<style>
        ...
        .bento-shadow {
            box-shadow: 0 4px 30px rgba(0, 27, 61, 0.05); /* Soft ambient shadow using Navy tone */
        }
    </style>
</head>
<body class="bg-background text-on-background font-display min-h-screen flex flex-col">
<!-- TopAppBar -->
<header class="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl sticky top-0 w-full z-50 border-b border-white/20 dark:border-slate-800/20 shadow-[0_4px_30px_rgba(0,0,0,0.05)] font-['Inter'] antialiased tracking-tight text-blue-600 dark:text-blue-400 flex justify-between items-center px-8 py-4">
<div class="flex items-center gap-8">
<div class="text-2xl font-black text-slate-900 dark:text-white tracking-tighter">FarmLift</div>
<nav class="hidden md:flex gap-6">
<a class="text-slate-600 dark:text-slate-400 font-medium hover:text-blue-500 dark:hover:text-blue-300 transition-all duration-300 active:scale-95 transition-transform" href="#">Marketplace</a>
<a class="text-slate-600 dark:text-slate-400 font-medium hover:text-blue-500 dark:hover:text-blue-300 transition-all duration-300 active:scale-95 transition-transform" href="#">Capacity</a>
<a class="text-slate-600 dark:text-slate-400 font-medium hover:text-blue-500 dark:hover:text-blue-300 transition-all duration-300 active:scale-95 transition-transform" href="#">Routes</a>
<a class="text-slate-600 dark:text-slate-400 font-medium hover:text-blue-500 dark:hover:text-blue-300 transition-all duration-300 active:scale-95 transition-transform" href="#">Sustainability</a>
</nav>
</div>
...
<!-- Footer -->
<footer class="bg-slate-950 dark:bg-black font-['Inter'] text-sm text-slate-400 w-full py-12 mt-20 border-t border-slate-800 px-8 grid grid-cols-1 md:grid-cols-2 lg:flex lg:justify-between items-start">
...
<a class="text-slate-500 hover:text-white transition-colors opacity-100 hover:opacity-80" href="#">Network</a>
<a class="text-slate-500 hover:text-white transition-colors opacity-100 hover:opacity-80" href="#">Carrier Portal</a>
</div>
<div class="flex flex-col gap-2">
